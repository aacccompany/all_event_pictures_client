...
import { IdCard, CloudUpload, Banknote, PencilRuler, UserRound } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 min-h-190 bg-grey-50 py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <p className="mt-4 text-lg text-slate-600 max-w-lg mx-auto lg:mx-0">
                    Register as a photographer on EventPic to participate in official photography.
                </p>
                ...
                <div className="mt-8 grid grid-cols-2 gap-x-8 gap-y-1 lg:flex lg:flex-col lg:items-start lg:space-y-5">
                    <FeatureItem icon={<IdCard className="h-8 w-8 text-blue-600" />} text="Official Free Pass" />
                    <FeatureItem icon={<CloudUpload className="h-8 w-8 text-blue-600" />} text="Easy To Manage" />
                    <FeatureItem icon={<Banknote className="h-8 w-8 text-blue-600" />} text="Make Money" />
                    <FeatureItem icon={<PencilRuler className="h-8 w-8 text-blue-600" />} text="Enjoy with Dev Tools" />
                </div>
            </div>
