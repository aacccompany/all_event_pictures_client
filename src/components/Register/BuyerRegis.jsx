...
import {
    // เปลี่ยนไอคอนให้สอดคล้องกับฟีเจอร์ของ User
    Search,
    DownloadCloud,
    CreditCard,
    Heart,
...
const BuyerRegis = ({ handleOnChange, handleSubmit }) => {
    return (
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 min-h-190 bg-grey-50 py-16 px-4 sm:px-6 lg:px-8">
            ...
            {/* === Right Form Section (โครงสร้างฟอร์มยังคงเดิม) === */}
            <div className="w-full max-w-md lg:w-1/2 mt-12 lg:mt-0">
                <form onSubmit={handleSubmit} className="w-full space-y-6 bg-white p-8 rounded-xl shadow-lg">
                    ...
                    {/* Input Fields (ยังคงเหมือนเดิมเพราะเป็นฟอร์มสมัครมาตรฐาน) */}
